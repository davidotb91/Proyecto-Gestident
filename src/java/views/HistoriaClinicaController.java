...
import entitis.HistoriaClinica;
import views.util.JsfUtil;
import views.util.PaginationHelper;
import models.HistoriaClinicaFacade;
...
public class HistoriaClinicaController implements Serializable {
    ...
    private HistoriaClinica current;
    private DataModel items = null;
    @EJB
    private models.HistoriaClinicaFacade ejbFacade;
    ...
    public String prepareView() {
        current = (HistoriaClinica) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("HistoriaClinicaCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("HistoriaClinicaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("HistoriaClinicaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class HistoriaClinicaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof HistoriaClinica) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + HistoriaClinica.class.getName());
            }
        }
